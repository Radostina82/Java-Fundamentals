        ...
        while (!input.equals("Retire")) {
            ...
            if (command.equals("Fire")) {
                ...
                if (index >= 0 && index <= pirateShip.size() - 1) {
                    if (pirateShip.get(index) + health <= healthCapacity) {
                ...
                int countPirateShip = 0;
                for (int i = 0; i <= pirateShip.size() - 1; i++) {
                    int element = pirateShip.get(i);
                    if (element < healthCapacity * 0.2) {
                        countPirateShip++;
                    }
                }
                System.out.printf("%d sections need repair.%n", countPirateShip);
            }
